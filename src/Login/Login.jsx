...
export default function Login(){
    return<>
        <div className="container-fluid login-screen d-flex justify-content-center align-items-center p-xl-5">
            <div className="row p-3 w-100 login-row d-flex flex-column flex-md-row justify-content-center align-items-center">
                ...
                <div className="p-3 col-md-6 d-flex align-items-center flex-column login-form">
                    ...
                    <form method="post" action="#" className="d-flex flex-column w-100 form">
                        ...
                        <button className="my-3 p-2 login-button">Sign Up</button>
                    </form>
                </div>
                <div class="login-div-image col-md-6 py-xl-4 d-flex align-items-center justify-content-center">
                    <picture>
                        ...
                        <img src="loginHr.jpg" alt="Attracting Job Seekers" class="login-image" />
                    </picture>
                </div>
